...
;; Primary colors
(defcustom monokai-yellow "#c9ce3b";; "#E6DB74" change to sunbeam yellow
  "Primary colors - yellow" ;; strings
  :type 'string
  :group 'monokai)
...
(defcustom monokai-red "#66D9EF";; ;; "#F92672" change to monokai blue
  "Primary colors - red" ;; ns/defn
  :type 'string
  :group 'monokai)
...
(defcustom monokai-blue "#AE81FF" ;;"#66D9EF" change to violet
  "Primary colors - blue"
  :type 'string
  :group 'monokai)

(defcustom monokai-green "#E6DB74";;"#A6E22E" change to monokai yellow
...
(defcustom monokai-violet "#3daee9";;"#AE81FF" change to plasma blue
  "Primary colors - violet" ;; keywords
  :type 'string
  :group 'monokai)
