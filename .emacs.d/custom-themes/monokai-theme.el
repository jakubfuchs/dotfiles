...
(defcustom monokai-red "#66D9EF"
  "Primary colors - breezed to monokai bue"
  :type 'string
  :group 'monokai)
...
(defcustom monokai-blue "#E6DB74"
  "Primary colors - breezed to monokai yelllow"
  :type 'string
  :group 'monokai)

(defcustom monokai-green-old "#A6E22E"
  "Primary colors - green"
  :type 'string
  :group 'monokai)

;;((((()))))
(defcustom monokai-green "#E6DB74"
  "Primary colors - breezed to monokai yellow"
  :type 'string
  :group 'monokai)
...
(let* (;; Variable pitch
  ...
  (custom-theme-set-faces
   ...
   ;; show-paren
   `(show-paren-match
     ((,monokai-class (:foreground ,monokai-green-old
                                   :background ,monokai-background
                                   :weight normal
                                   :inverse-video t))
      (,monokai-256-class (:foreground ,monokai-256-green
