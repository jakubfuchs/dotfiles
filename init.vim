...
"" toggle json pretty format in buffer
noremap <leader><leader>J :%!python -m json.tool<CR>
"Show hidden chars
...
" Resizing
" TODO implement resizing on alt + left, etc...
"
...
set wildignore+=*.orig                           " Merge resolution files<Paste>
